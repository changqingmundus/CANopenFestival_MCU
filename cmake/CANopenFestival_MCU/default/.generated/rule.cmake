...
function(CANopenFestival_MCU_default_link_rule target)
    set(options
        "-g"
        "-mcpu=33CK256MP502"
...
function(CANopenFestival_MCU_default_bin2hex_rule target)
    add_custom_target(
        CANopenFestival_MCU_default_Bin2Hex ALL
        COMMAND ${MP_BIN2HEX} ${CANopenFestival_MCU_default_image_name} -a -mdfp=${PACK_REPO_PATH}/Microchip/dsPIC33CK-MP_DFP/1.15.423/xc16
        WORKING_DIRECTORY ${CANopenFestival_MCU_default_output_dir}
        BYPRODUCTS "${CANopenFestival_MCU_default_output_dir}/${CANopenFestival_MCU_default_image_base_name}.hex"
        COMMENT "Convert build file to .hex")
    add_dependencies(CANopenFestival_MCU_default_Bin2Hex ${target})
endfunction()
